...
import jp.ac.meijou.android.s241205183.databinding.ActivityMain7Binding;
...
public class MainActivity7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = jp.ac.meijou.android.s241205183.databinding.ActivityMain7Binding.inflate(getLayoutInflater());
        ...
        private void updateIpAddress (Network network){
            ...
            if (linkProperties != null) {
                ...
                binding.textViewIP.setText(addresses);
            }
